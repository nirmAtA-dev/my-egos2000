...
#define MASK_ZFH (1U << 0)
#define MASK_ZFHMIN (1U << 1)
#define MASK_ZVFBFMIN (1U << 2)
#define MASK_ZVFH (1U << 3)
#define MASK_ZVFHMIN (1U << 4)
...
#define MASK_ZICOND (1U << 4)
#define MASK_ZICSR (1U << 5)
#define MASK_ZIFENCEI (1U << 6)
#define MASK_ZIHINTNTL (1U << 7)
#define MASK_ZIHINTPAUSE (1U << 8)
...
enum opt_code
{
  ...
  OPT__param_riscv_strcmp_inline_limit_ = 290,/* --param=riscv-strcmp-inline-limit= */
  ...
  OPT__param_uninit_max_chain_len_ = 331,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 332,   /* --param=uninit-max-num-chains= */
  OPT__param_uninlined_function_insns_ = 333,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 334, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 335,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 336,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 337,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 338,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 339,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 340,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 341,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 342,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_induction_float_ = 343,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 344,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 345,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 346,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 347,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 348,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 349,/* --param=vect-partial-vector-usage= */
  OPT__param_vrp_sparse_threshold_ = 350,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 351,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 352,    /* --param=vrp-vector-threshold= */
  OPT__param_vsetvl_strategy_ = 353,         /* --param=vsetvl-strategy= */
  ...
  /* OPT__print_supported_extensions = 373, *//* --print-supported-extensions */
  /* OPT__print_sysroot = 374, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 375, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 376, */                  /* --profile */
  /* OPT__save_temps = 377, */               /* --save-temps */
  /* OPT__shared = 378, */                   /* --shared */
  /* OPT__specs = 379, */                    /* --specs */
  /* OPT__specs_ = 380, */                   /* --specs= */
  /* OPT__static = 381, */                   /* --static */
  /* OPT__static_pie = 382, */               /* --static-pie */
  /* OPT__symbolic = 383, */                 /* --symbolic */
  /* OPT__sysroot = 384, */                  /* --sysroot */
  OPT__sysroot_ = 385,                       /* --sysroot= */
  OPT__target_help = 386,                    /* --target-help */
  /* OPT__time = 387, */                     /* --time */
  /* OPT__trace_includes = 388, */           /* --trace-includes */
  /* OPT__traditional = 389, */              /* --traditional */
  /* OPT__traditional_cpp = 390, */          /* --traditional-cpp */
  /* OPT__trigraphs = 391, */                /* --trigraphs */
  /* OPT__undefine_macro = 392, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 393, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 394, */        /* --user-dependencies */
  /* OPT__verbose = 395, */                  /* --verbose */
  OPT__version = 396,                        /* --version */
  /* OPT__write_dependencies = 397, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 398, */  /* --write-user-dependencies */
  OPT_A = 399,                               /* -A */
  OPT_B = 400,                               /* -B */
  OPT_C = 401,                               /* -C */
  OPT_CC = 402,                              /* -CC */
  ...
  OPT_list = 1957,                           /* -list */
  OPT_mabi_ = 1958,                          /* -mabi= */
  OPT_madjust_lmul_cost = 1959,              /* -madjust-lmul-cost */
  OPT_malign_data_ = 1960,                   /* -malign-data= */
  OPT_march_ = 1961,                         /* -march= */
  OPT_march_help = 1962,                     /* -march=help */
  OPT_mbig_endian = 1963,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1964,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1965,                       /* -mcmodel= */
  OPT_mcpu_ = 1966,                          /* -mcpu= */
  OPT_mcsr_check = 1967,                     /* -mcsr-check */
  OPT_mdiv = 1968,                           /* -mdiv */
  OPT_mexplicit_relocs = 1969,               /* -mexplicit-relocs */
  OPT_mfdiv = 1970,                          /* -mfdiv */
  OPT_minline_atomics = 1971,                /* -minline-atomics */
  OPT_minline_strcmp = 1972,                 /* -minline-strcmp */
  OPT_minline_strlen = 1973,                 /* -minline-strlen */
  OPT_minline_strncmp = 1974,                /* -minline-strncmp */
  OPT_misa_spec_ = 1975,                     /* -misa-spec= */
  OPT_mlittle_endian = 1976,                 /* -mlittle-endian */
  OPT_mmovcc = 1977,                         /* -mmovcc */
  OPT_momit_leaf_frame_pointer = 1978,       /* -momit-leaf-frame-pointer */
  OPT_mplt = 1979,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1980,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1981,                         /* -mrelax */
  OPT_mriscv_attribute = 1982,               /* -mriscv-attribute */
  OPT_mrvv_max_lmul_ = 1983,                 /* -mrvv-max-lmul= */
  OPT_mrvv_vector_bits_ = 1984,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1985,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1986,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1987,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 1988, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1989,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1990,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1991,                  /* -mstrict-align */
  OPT_mstringop_strategy_ = 1992,            /* -mstringop-strategy= */
  OPT_mtls_dialect_ = 1993,                  /* -mtls-dialect= */
  OPT_mtune_ = 1994,                         /* -mtune= */
  OPT_n = 1995,                              /* -n */
  OPT_name_sort = 1996,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1997,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1998,              /* -no-integrated-cpp */
  OPT_no_pie = 1999,                         /* -no-pie */
  OPT_nocpp = 2000,                          /* -nocpp */
  OPT_nodefaultlibs = 2001,                  /* -nodefaultlibs */
  OPT_nolibc = 2002,                         /* -nolibc */
  OPT_nophoboslib = 2003,                    /* -nophoboslib */
  OPT_nostartfiles = 2004,                   /* -nostartfiles */
  OPT_nostdinc = 2005,                       /* -nostdinc */
  OPT_nostdinc__ = 2006,                     /* -nostdinc++ */
  OPT_nostdlib = 2007,                       /* -nostdlib */
  OPT_nostdlib__ = 2008,                     /* -nostdlib++ */
  OPT_o = 2009,                              /* -o */
  OPT_objects = 2010,                        /* -objects */
  OPT_p = 2011,                              /* -p */
  OPT_pass_exit_codes = 2012,                /* -pass-exit-codes */
  /* OPT_pedantic = 2013, */                 /* -pedantic */
  OPT_pedantic_errors = 2014,                /* -pedantic-errors */
  OPT_pg = 2015,                             /* -pg */
  OPT_pie = 2016,                            /* -pie */
  OPT_pipe = 2017,                           /* -pipe */
  OPT_print_file_name_ = 2018,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2019,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2020,          /* -print-multi-directory */
  OPT_print_multi_lib = 2021,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2022,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2023,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2024,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2025,               /* -print-prog-name= */
  OPT_print_search_dirs = 2026,              /* -print-search-dirs */
  /* OPT_print_supported_extensions = 2027, *//* -print-supported-extensions */
