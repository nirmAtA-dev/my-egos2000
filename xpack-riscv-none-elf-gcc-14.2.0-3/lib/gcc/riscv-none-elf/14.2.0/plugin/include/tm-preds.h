/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/__w/riscv-none-elf-gcc-xpack/riscv-none-elf-gcc-xpack/build-assets/build/linux-x64/sources/gcc-14.2.0/gcc/config/riscv/riscv.md'.  */
...
extern bool arith_operand_or_mode_mask (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_m && c <= CONSTRAINT_th__m__miu;
}
...
{
  if (c >= CONSTRAINT_c01 && c <= CONSTRAINT_CV__simd__i03)
    return;
